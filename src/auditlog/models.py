...
class LogEntry(models.Model):
    ...
    actor = models.ForeignKey(to=settings.AUTH_USER_MODEL, db_constraint=False, on_delete=models.SET_NULL, blank=True, null=True, related_name='+', verbose_name=_("actor"))
    affected_user = models.ForeignKey(to=settings.AUTH_USER_MODEL, db_constraint=False, on_delete=models.SET_NULL, blank=True, null=True, related_name='affecting_log_entries', verbose_name=_("affected user"))
